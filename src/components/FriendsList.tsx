...
const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    lastSeen: new Date(Date.now() - 1000 * 60 * 15), // 15 мин назад
    isOnline: false,
  },
  {
    id: 3,
    ...
    lastSeen: new Date(Date.now() - 1000 * 60 * 60 * 3), // 3 часа назад
    isOnline: false,
  },
  {
    id: 4,
...
const ConfDelete: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        className="absolute inset-0 bg-gray-100 bg-opacity-50 transition-opacity"
        onClick={onCancel}
      ></div>
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6 z-10">
        ...
        <p className="text-gray-600 mb-6">
          ...
          <span className="font-medium">{userName}</span> из друзей? Вы больше
          не сможете писать друг другу, пока снова не добавите в друзья.
        </p>
